...
The aim of the leading example is two-fold: first we want to concretize the maps using our general description in the first part of this paper. Secondly, we want to provide argumentative insight for the following examples. 
...
Note that however in the following section we will use the term subduality more loosely to also refer to dualities for which the duality in question is a subduality (one might define it analogously as superduality), or dualities which arise by restriction/extension and composition/decomposition.
 ...
 That is to say, we will refer to every horizontal duality of the big diagram at the end of this section loosely as a subduality of the Stone duality, even though the Stone duality is at the bottom.
